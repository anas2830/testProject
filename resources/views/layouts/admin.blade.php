...
<head>
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('super-admin')}}/plugins/daterangepicker/daterangepicker.css">
  <!-- summernote -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link @if($activeMenu == 'home' || $activeMenu == 'blog-post' || $activeMenu == "questions" ) active @endif">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="@if(Auth::guard('admin')->check()) {{ url('courseQuestionArchive') }} @else {{ url('courseQuestionArchive') }} @endif" class='nav-link @if($activeMenu == "questions") active @endif'>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Questions</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="@if(Auth::guard('admin')->check()) {{ url('classExamConfig') }} @else {{ url('classExamConfig') }} @endif" class='nav-link @if($activeMenu == "classExamConfig") active @endif'>
                  <i class="far fa-circle nav-icon"></i>
                  <p>Exam Config</p>
                </a>
              </li>
