...
<form class="form-horizontal form-validate-jquery" action="@if(Auth::guard('admin')->check()) {{url('handleBlogAdmin', [$blog->id])}} @else  {{url('handleBlogModerator', [$blog->id])}}@endif" method="POST" enctype="multipart/form-data">
    @method('PUT')
    @csrf
