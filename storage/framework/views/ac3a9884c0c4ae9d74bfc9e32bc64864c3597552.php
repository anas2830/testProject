      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="" style="padding:2%">
              ...
              <form class="form-horizontal form-validate-jquery" action="<?php echo e(route('courseQuestionArchive.update', [$question->id])); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="select-search" name="answer_type"  id="answer_type" required>
                                ...
                                <?php $__currentLoopData = $answerType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($type->id); ?>" <?php if($type->id==$question->answer_type): ?><?php echo e("selected"); ?><?php endif; ?>><?php echo e($type->answer_type); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>

                    <div class="form-group" id="answerDiv" <?php if($question->answer_type<=0): ?><?php echo e("style=display:none;"); ?><?php endif; ?>>
                        <label class="control-label col-lg-2">Answer <span class="text-danger">*</span></label>
                        <div class="col-lg-10" id="answer_view_1"  <?php if($question->answer_type!=1): ?><?php echo e("style=display:none;"); ?><?php endif; ?>>
                            <div class="checkbox checkbox-switch">
                                
                                <label>
                                    <input type="checkbox" data-on-text="True" data-off-text="False" class="switch" id="answer" name="answer_tf" value="1" <?php if($question->answer_type==1 && @$answer[0]->true_answer==1): ?><?php echo e("checked"); ?><?php endif; ?>>
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-10" id="answer_view_2_3" <?php if($question->answer_type!=2 && $question->answer_type!=3): ?><?php echo e("style=display:none;"); ?><?php endif; ?>>
                                    ...
                                    <div class="col-md-3 btnView">
                                        <div class="toggle-custom mr10" style="display: inline-block">
                                            <label class="toggle answerCheck" data-on="Yes" data-off="No">
                                                <input name="true_answer[]" class="trueAnswer mr-5" type="<?php echo e(($question->answer_type==3)?'check':'radio'); ?>" value="0"> <span class="button-<?php echo e(($question->answer_type==3)?'check':'radio'); ?>"></span>
                                            </label>
                                        </div>
                            ...
                            <?php else: ?> 
                                ...
                                <?php $__currentLoopData = $answer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$ans): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="row">
                                    <div class="col-md-9 pr0 mb10">
                                        <input name="answer[]" placeholder="Answer" class="form-control mb-5" value="<?php echo e($ans->answer); ?>">
                                        <input name="answer_id[]" type="hidden" value="<?php echo e($ans->id); ?>">
                                    </div>
                                    <div class="col-md-3 btnView"><div class="toggle-custom mr10" style="display: inline-block">
                                        <label class="toggle answerCheck" data-on="Yes" data-off="No">
                                            <input name="true_answer[]" class="trueAnswer mr-5" type="<?php echo e(($question->answer_type==3)?'checkbox':'radio'); ?>" value="<?php echo e($index); ?>" <?php if($ans->true_answer==1): ?><?php echo e("checked"); ?><?php endif; ?>> <span class="button-<?php echo e(($question->answer_type==3)?'checkbox':'radio'); ?>"></span>
                                        </label>
                                    </div>
                                    <?php 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel-blog-v1\resources\views/super-admin/archiveQuestion/update.blade.php ENDPATH**/ ?>